...
<template>
    <section :id="content?.id" class="py-16 lg:py-24 relative px-5 lg:px-0">
        <div class="relative md:h-[50vh] flex items-center justify-center w-full bg-no-repeat bg-fixed bg-primary-1 container rounded-xl mx-auto drop-shadow-2xl drop-shadow-primary-1/15"
            >
